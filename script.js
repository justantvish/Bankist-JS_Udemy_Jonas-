...
btnScrollTo.addEventListener('click', function(e) {
  ...
  // console.log(s1coords.top,'vs.', s1coords.top + window.pageYOffset);
...
// 2. Determinr what element originated the event
...
///// My code
// const navFade = function(event, op) {
...
/////// Types of Evenets and Event Handlers
...
// console.log(h1.children); // only direct childrens
